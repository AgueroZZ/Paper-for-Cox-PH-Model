...
\begin{table}
  ...
  \begin{tabular}{||c c c||}
   \hline
   $\sigma$  & $\gamma(u_i)$ (max) & $\gamma(u_i)$ (mean) \\
   \hline\hline
   0.035 & 0.027 & 0.021\\
    \hline \hline
  \end{tabular}
  ...
  \end{center}
  \caption{KS statistic for each parameter in the second simulation study in section \ref{subsubsec:sim2}, to compare the proposed approach with MCMC.}
  \label{table:Sim2KS}
  \end{table}
