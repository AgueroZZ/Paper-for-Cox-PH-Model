...
\subcaptionbox{True baseline hazard function}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{true_baseline.png}
}
\subcaptionbox{Estimated baseline hazard function using INLA}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{inla_baseline.png}
}
\subcaptionbox{Posterior estimate of covariate effect}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{smoothing_simulation.png}
}
\subcaptionbox{Posterior distribution of $\sigma$}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{simulation_hyper.png}
}
...
\subcaptionbox{Posterior effect of \texttt{tpi}}{
  \includegraphics[width=0.45\textwidth,height=2.5in]{leuk_smooth.png}
}
\subcaptionbox{Posterior distribution of $\sigma$}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{leuk_posterior.png}
}
...
\centering
\subcaptionbox{Posterior distribution of $\sigma$}{
	\includegraphics[width=0.45\textwidth,height=2.5in]{kidney_poster.png}
}
